...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3 class="panel-title">Upload Surat TRC</h3>
	</div>

	<form action="<?php echo base_url('ksb_pel/pengajuan/upload_surat_trc') ?>" method="POST" enctype="multipart/form-data">
...
Mohon ditindaklanjuti
		...
		<div class="panel-body">
			<input type="submit" class="btn btn-success btn-block" value="Upload Surat TRC">
		</div>
	</form>	
