<li class="parent">
    ...
    <ul class="submenu collapse" id="pengajuan">
        ...
        <li class="">
            <a data-toggle="tooltip" title="Tambah Pengajuan" href="<?php echo base_url('ppk/pengajuan/tambah') ?>">
                <span class="text">Tambah Pengajuan</span>
            </a>
        </li>
        <li class="">
            <a data-toggle="tooltip" title="Daftar Pengajuan" href="<?php echo base_url('ppk/pengajuan/') ?>">
