              ...
              <div class="container-fluid">
                <div class="page-header page-header-block" style="margin-left: -30px; margin-right: -30px;">
                  <div class="page-header-section">
                    <h4 class="title semibold">SiAP (Sistem Aplikasi Pengadaan) Bagian Layanan Pengadaan - Kabupaten Bangli </h4>
                  </div>
                </div>
              </div>
                <div class="row" >
                ...
                <a href="<?=base_url()?>/resources/image/flowchart-blp.jpg" target="_blank">
                <img height="280px" src="?=base_url()?>/resources/image/flowchart-blp.jpg" >
                <a>
                </div>
                            </div>
                        </div>
        ...
        <footer id="footer">
           ...
           <div class="container-fluid">
               <div class="row">
                   <div class="col-sm-6">
                       <!-- copyright -->
                       <p class="nm text-muted">Bagian Layanan Pengadaan Kabupaten Buleleng &copy; <span class="semibold">2018</span></p>
                       <!--/ copyright -->
                   </div>
               </div>
           </div>
