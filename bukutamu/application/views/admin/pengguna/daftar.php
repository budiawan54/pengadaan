    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-light">
                                ...
                                foreach ($pengguna as $key => $value) {
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url('pengguna/detail/'.$value['Id_User']) ?>" class="label label-success">Detail</a>
                                            </td>
                                        </tr>
                                    <?php
                                }
            ...
            <div class="panel-footer">
                <a href="<?php echo base_url('pengguna/tambah') ?>" class="button button-md button-blue">Tambah Pengguna</a>
            </div>
