...
<div class="panel-body">
    ...
    <div class="tab-content panel">
        ...
        <div class="tab-pane np" id="comments">
            <div class="panel-body">
                <form action="<?php echo base_url('pengguna/resetPass/'.$User['Id_User']) ?>" method="POST" class="form-horizontal">
      ...
      <div class="modal-dialog ">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form action="<?php echo base_url('pengguna/nonaktif') ?>" method="POST" id="form-pokja-kaji" enctype="multipart/form-data">
      ...
      <div class="modal-dialog ">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form action="<?php echo base_url('pengguna/aktif') ?>" method="POST" id="form-pokja-kaji" enctype="multipart/form-data">
                <input type="hidden" name="Id_User" value="<?php echo $User['Id_User'] ?>">
